...
class MessagingViewController: UIViewController {
  ...
  lazy var apnsStatusTableCell: UITableViewCell = {
    let cell = UITableViewCell(style: UITableViewCell.CellStyle.value1, reuseIdentifier: Row.apnsStatus.rawValue)
...
// MARK: - UI Controls
extension MessagingViewController {
    @objc func onRequestUserNotificationsButtonTapped(sender: UIButton) {
