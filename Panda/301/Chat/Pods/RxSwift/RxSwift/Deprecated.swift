...
extension Observable {
     ...
     */
    @available(swift, deprecated, message: "Implicit conversions from any type to optional type are allowed and that is causing issues with `from` operator overloading.", renamed: "from(optional:)")
    ...
    /**
     ...
     - returns: An observable sequence containing the wrapped value or not from given optional.
     */
    @available(swift, deprecated, message: "Implicit conversions from any type to optional type are allowed and that is causing issues with `from` operator overloading.", renamed: "from(optional:scheduler:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Please use enumerated().map()")
     ...
     */
    @available(swift, deprecated, message: "Please use enumerated().flatMap()")
     ...
     */
    @available(swift, deprecated, message: "Please use enumerated().skipWhile().map()")
     ...
     */
    @available(swift, deprecated, message: "Please use enumerated().takeWhile().map()")
...
extension Disposable {
    ...
    @available(swift, deprecated, message: "use disposed(by:) instead", renamed: "disposed(by:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "use share(replay: 1) instead", renamed: "share(replay:)")
...
extension ObservableType {
    ...
    /**
     ...
     - returns: An observable sequence that contains the elements of a sequence produced by multicasting the source sequence.
     */
    @available(swift, deprecated, message: "Suggested replacement is `share(replay: 1)`. In case old 3.x behavior of `shareReplay` is required please use `share(replay: 1, scope: .forever)` instead.", renamed: "share(replay:)")
...
@available(swift, deprecated, message: "Variable is deprecated. Please use `BehaviorRelay` as a replacement.")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "delay(_:scheduler:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timeout(_:scheduler:)")
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timeout(_:other:scheduler:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "skip(_:scheduler:)")
...
extension ObservableType where Element : RxAbstractInteger {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "interval(_:scheduler:)")
...
extension ObservableType where Element: RxAbstractInteger {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timer(_:period:scheduler:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "throttle(_:latest:scheduler:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "take(_:scheduler:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "delaySubscription(_:scheduler:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "window(_:)")
...
extension PrimitiveSequenceType where Trait == SingleTrait {
     ...
     */
    @available(swift, deprecated, renamed: "do(onSuccess:onError:onSubscribe:onSubscribed:onDispose:)")
...
extension ObservableType {
     ...
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "buffer(timeSpan:count:scheduler:)")
...
extension PrimitiveSequenceType where Element: RxAbstractInteger
{
    /**
     ...
     - returns: An observable sequence that produces a value after due time has elapsed and then each period.
     */
    @available(swift, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timer(_:scheduler:)")
...
extension Completable {
     ...
     */
    @available(swift, deprecated, message: "Use Completable.zip instead.", renamed: "zip")
