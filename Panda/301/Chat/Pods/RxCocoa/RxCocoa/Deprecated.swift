...
extension ObservableType {
    ...
    extension NSTextStorage {
        @available(iOS, unavailable, message: "createRxDelegateProxy is now unavailable, check DelegateProxyFactory")
        ...
        return Binder(base) { imageView, image in
            if let transitionType = transitionType {
                if image != nil {
                    ...
                    transition.type = convertToCATransitionType(CATransitionType(string: transitionType).rawValue as String)
